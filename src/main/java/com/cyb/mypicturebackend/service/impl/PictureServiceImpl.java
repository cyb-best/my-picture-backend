...
import com.cyb.mypicturebackend.manager.FileManager;
import com.cyb.mypicturebackend.manager.upload.FilePictureUpload;
import com.cyb.mypicturebackend.manager.upload.PictureUploadTemplate;
import com.cyb.mypicturebackend.manager.upload.UrlPictureUpload;
import com.cyb.mypicturebackend.mapper.PictureMapper;
import com.cyb.mypicturebackend.model.dto.file.UploadPictureResult;
import com.cyb.mypicturebackend.model.dto.picture.PictureQueryRequest;
import com.cyb.mypicturebackend.model.dto.picture.PictureReviewRequest;
import com.cyb.mypicturebackend.model.dto.picture.PictureUploadByBatchRequest;
import com.cyb.mypicturebackend.model.dto.picture.PictureUploadRequest;
 ...
 * @createDate 2025-01-18 14:17:17
 */
@Slf4j
@Service
    ...
    public PictureVO uploadPicture(Object inputSource, PictureUploadRequest pictureUploadRequest, User loginUser) {
        ...
        transactionTemplate.execute(status -> {
            ...
            if (finalSpaceId != null) {
                ...
                String message = String.format("用户%s上传私有图片, 默认通过", loginUser.getId());
